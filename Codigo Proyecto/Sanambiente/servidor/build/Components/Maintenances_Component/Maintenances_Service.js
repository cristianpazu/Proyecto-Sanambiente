...
class MaintenanceService {
    ...
    create(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let { id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, observacion_validacion, novedad_mantenimiento } = request.body;
                yield basedatos_1.default.query(Handle_Queries_1.handlerQuery['createMaintenance'], [id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, observacion_validacion, novedad_mantenimiento]);
    ...
    update(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let { id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, observacion_validacion, novedad_mantenimiento } = request.body;
                yield basedatos_1.default.query(Handle_Queries_1.handlerQuery['updateMaintenance'], [id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, observacion_validacion, novedad_mantenimiento, id_mantenimiento]);
