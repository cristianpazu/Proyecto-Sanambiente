    ...
    create(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield basedatos_1.default.query(Handle_Queries_1.handlerQuery['createMaintenance'], [id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, validacion_mantenimiento, novedad_mantenimiento, fecha_creacion]);
    ...
    update(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield basedatos_1.default.query(Handle_Queries_1.handlerQuery['updateMaintenance'], [id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, novedad_mantenimiento, id_mantenimiento, fecha_creacion]);
