...
class StationService {
    create(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let { nombre_estacion, serial_estacion, nombre_corto_estacion, id_organizacion, id_categoria, id_tiempo, observacion_estacion, id_region, id_ciudad, latitud_estacion, longitud_estacion, elevacion_estacion, gmt_estacion, protocolo_estacion } = request.body;
                yield basedatos_1.default.query(Handle_Queries_1.handlerQuery['createStation'], [nombre_estacion, serial_estacion, nombre_corto_estacion, id_organizacion, id_categoria, id_tiempo, observacion_estacion, id_region, id_ciudad, latitud_estacion, longitud_estacion, elevacion_estacion, gmt_estacion, protocolo_estacion]);
    ...
    update(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let { nombre_estacion, serial_estacion, nombre_corto_estacion, id_organizacion, id_categoria, id_tiempo, observacion_estacion, id_region, id_ciudad, latitud_estacion, longitud_estacion, elevacion_estacion, gmt_estacion, protocolo_estacion } = request.body;
                yield basedatos_1.default.query(Handle_Queries_1.handlerQuery['updateStation'], [nombre_estacion, serial_estacion, nombre_corto_estacion, id_organizacion, id_categoria, id_tiempo, observacion_estacion, id_region, id_ciudad, latitud_estacion, longitud_estacion, elevacion_estacion, gmt_estacion, protocolo_estacion, id_estacion]);
