...
class MaintenanceService implements BaseService<any> {
    ...
    async update(request: Request, response: Response): Promise<any> {
        try {
            ...
            await ConnectionDataBase.query(handlerQuery['updateMaintenance'], [id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, novedad_mantenimiento, id_mantenimiento]);
