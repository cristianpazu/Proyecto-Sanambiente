...
class MaintenanceService implements BaseService<any> {
    ...
    async create(request: Request, response: Response): Promise<any> {
        try {
            ...
            await ConnectionDataBase.query(handlerQuery['createMaintenance'], [id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, observacion_validacion, novedad_mantenimiento]);
    ...
    async update(request: Request, response: Response): Promise<any> {
        try {
            ...
            let { id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, observacion_validacion, novedad_mantenimiento } = request.body;
            await ConnectionDataBase.query(handlerQuery['updateMaintenance'], [id_estacion, id_parte, id_tipo_mantenimiento, id_periodicidad, fecha_inicial, fecha_final, nombre_funcionario, observacion_validacion, novedad_mantenimiento, id_mantenimiento]);
